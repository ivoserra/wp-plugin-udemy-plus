...
function up_recipe_post_type(){
    ...
    $args = array(
          ...
          'hierarchical'       => false,
          'menu_position'      => 20,
          'supports'           => array( 'title', 'editor', 'author', 'thumbnail', 'excerpt', 'custome-fields'),
          // gutenburg editor to make a post
          'show_in_rest'       => true,
      ...
      register_term_meta('cuisine', 'more_info_url',[
        'type' => 'string',
        'description' => __('A link to more info about the cuisine', 'udemy-plus'),
        'single' => true,
        'show_in_rest' => true,
        'default' => '#',
      ]);
      ...
      register_post_meta('recipe', 'recipe_rating', [
        'type' => 'number',
        'description' => __('The rating for the recipe', 'udemy-plus'),
        'single' => true,
        'show_in_rest' => true,
        'default' => 0,
      ]);
